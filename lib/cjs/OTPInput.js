...
var OTPInput = function (otpInputProps) {
    ...
    return (react_1.default.createElement("div", { className: props.containerClassName, style: { display: "flex", alignItems: 'center' } }, inputs.map(function (value, index) { return (react_1.default.createElement("div", { key: index },

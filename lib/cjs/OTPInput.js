...
var OTPInput = function (otpInputProps) {
    ...
    var _a = react_1.default.useState(defaultValues), inputs = _a[0], setInputs = _a[1];
    var inputRefs = react_1.default.useRef([]);
    var _b = react_1.default.useState(props.autoFocus ? 0 : null), activeInput = _b[0], setActiveInput = _b[1];
